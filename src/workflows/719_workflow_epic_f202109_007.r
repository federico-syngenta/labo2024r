...
CA_catastrophe_base <- function( pinputexps, metodo )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/z1201_CA_reparar_dataset_FR.r"
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/z1301_FE_intrames_manual_FR.r"
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c( 201903,201904, 201907, 201908,
                                         201911, 201912, 202011, 202012,
                                        202103, 202104)
  
  
  param_local$train$training <- c( 201901,201902,201905,201906, 201909,
                                   201910, 202001, 202002,202003,
                                   202101, 202102, 202105, 202106)
