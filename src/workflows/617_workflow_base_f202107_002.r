...
wf_julio <- function( pnombrewf, ratio, desvio )
{
  ...
  CN_canaritos_asesinos_base(ratio=ratio, desvio=desvio)
...
# Valores a asignar
ratios <- c(0.45,0.45,0.95,0.95,0.3,0.55,1.0,0.4,1.63,0.25,0.5,1.1,1.7,0.9599,0.2463,0.293785,0.05,0.666,1.2,0.25,0.95)
desvios <- c()
...
for (i in 1:length(ratios)) {
  ...
  resultado <- wf_julio("nombre_wf_007", ratios[i], desvios[i])  # Llamar a la función con los nuevos valores
