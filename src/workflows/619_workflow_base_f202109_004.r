###############################################################################
# Voy a generar una corrida con algunas cosas cambiadas por mi al azar
#si bien mi tema es Canaritos asesinos quiero ver como funciona cunado cambio cosas
###############################################################################
