...
hs <- makeParamSet(
  ...
  makeNumericParam("lambda_l1", lower = 0.0, upper = 1000.0), #SE AGREGO
  makeNumericParam("lambda_l2", lower = 0.0, upper = 1000.0) #SE AGREGO
)
...
EstimarGanancia_lightgbm <- function(x) {
  ...
  param_basicos <- list(
    ...
    min_gain_to_split = 1.0, # Cambiado! antes era 0
    lambda_l1 = 10, # cambiado! antes era 0
    lambda_l2 = 10, # cambiado! antes era 0
    max_bin = 99, # cambiado! antes era 31
